  ...
  return (
    <div className="animate-in">
      <div className="text-center mb-8">
        <h1 className="font-display text-3xl font-bold text-cherish-900 mb-2">Welcome back</h1>
        <p className="text-sm text-cherish-900/50">Sign in to your Cherish account</p>
      </div>
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <span className="text-xs text-cherish-900/30 font-medium">or sign in with email</span>
        <div className="h-px flex-1 bg-cherish-300/30" />
      </div>
      ...
      <form onSubmit={handleLogin} className="space-y-3.5">
        ...
        <div>
          ...
          <input className="input-field" type="password" placeholder="Your password" value={password} onChange={(e) => setPassword(e.target.value)} required />
        </div>
      ...
      <p className="text-center text-sm text-cherish-900/50 mt-6">
        ...
        <Link href="/signup" className="text-cherish-500 font-medium">Create one free</Link>
      </p>
    </div>
  );
}
