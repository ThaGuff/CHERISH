...
const tiers = [
  {
    ...
    features: ["Unlimited pages & memory books", "All 6 creation modes", "Voice transcription", "Family Circle sharing", "Cloud backup & sync", "Pay only when you print"],
    cta: "Get Started Free",
  },
  {
    name: "Pro", price: "$4.99", period: "/month", highlight: true, badge: "MOST POPULAR",
    features: ["Everything in Free", "All premium sticker packs", "All 4 visual themes", "HD photo quality", "Public profile & Explore", "10% off print orders", "On This Day reminders", "Priority support"],
    cta: "Start Free Trial",
  },
  {
    name: "Family", price: "$7.99", period: "/month", highlight: false, badge: "BEST VALUE",
    features: ["Everything in Pro for up to 5", "Shared memory books", "Collaborative pages", "15% off all print orders", "Family analytics"],
